...
namespace LottoNumbersService
{
    ...
    public static class Utility
    {
        ...
        internal static int GetLottoUpdateHourMin()
        {
            ...
            if (!DateTime.TryParse(ConfigurationManager.AppSettings["LottoUpdateTime"].ToUpper(), out dt))
            {
        ...
        internal static int GetLottoUpdateHour()
        {
            DateTime dt;
        ...
        internal static void LogMessageToFile(string msg)
        {
            ...
            var sw = File.AppendText(ConfigurationManager.AppSettings["logFile"]);
