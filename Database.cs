...
namespace LottoNumbersService
{
    public static class Database
    {
        ...
        /// sp: Stored Procedure
        /// tbl: Table name
        /// obj: Entity to insert to tbl.
        /// </summary>
        internal static void InsertEntity<T>(string sp, string tbl, T obj)
        {
            try
            {
        ...
        internal static int LoadEntities<T>(string sp, out List<T> obj, List<Tuple<int, string, int>> parameters = null)
        {
            try
            {
                obj = null;
